...
RUN\
	...
	mkdir es-data &&\
	wget https://download.elastic.co/kibana/kibana/kibana-$KB_VER-linux-x86_64.tar.gz &&\
	tar xzvf kibana-$KB_VER-linux-x86_64.tar.gz &&\
	rm kibana-$KB_VER-linux-x86_64.tar.gz &&\
	ln -s kibana-$KB_VER-linux-x86_64 kb &&\
